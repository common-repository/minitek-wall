<?php
/**
 * This file is used to markup the list layout.
 *
 * @since      1.0.1
	...
	?><div class="mwall-item <?php 
		...
		?><div class="mwall-item-outer-cont <?php 
			...
			?>" style="<?php 
				...
				{ 
					?>border-radius: <?php echo $wall_border_radius; ?>px; <?php 
				}
			...
			?><div class="mwall-item-inner-cont" style="background-color: rgba(<?php echo $options['db_bg_class']; ?>,<?php echo $options['db_bg_opacity_class']; ?>);"><?php 
				...
				{ 
					?><div class="mwall-cover <?php echo $hoverOffset; ?> <?php echo $perspective; ?>">
						<div class="mwall-img-div <?php echo $flipBase; ?> <?php echo $flipClass; ?>" style="<?php echo $animated_flip; ?>">
